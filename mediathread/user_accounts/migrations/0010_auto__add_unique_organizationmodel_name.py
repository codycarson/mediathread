...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'OrganizationModel', fields ['name']
        db.create_unique('user_accounts_organizationmodel', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'OrganizationModel', fields ['name']
        db.delete_unique('user_accounts_organizationmodel', ['name'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 5, 16, 41, 36, 21800)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 5, 16, 41, 36, 21709)'}),
