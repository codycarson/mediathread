...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CourseInformation.invites_left'
        db.add_column('course_courseinformation', 'invites_left', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CourseInformation.invites_left'
        db.delete_column('course_courseinformation', 'invites_left')
